        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <nav class="nav-desktop">
                    ...
                    <a href="/Skinscan/aboutus" class="nav-link active">About Us</a>
                </nav>
            ...
            <nav class="nav-mobile" id="mobileNav">
                ...
                @guest
                    <a href="{{ route('login') }}" class="btn-secondary-mobile">Login</a>
                    <a href="{{ route('register') }}" class="cta-button-mobile">Sign up</a>
                @endguest
